                    ...
                    <div class="my-5">
                        <form id="contactForm" #f="ngForm" (ngSubmit)="sendLogin(f)">
                            <div class="form-floating">
                                <input class="form-control" id="name" type="text" name="email" placeholder="Enter your Email..." #email="ngModel" [ngModel]="modelUser" required />
                            ...
                            <div class="d-grid gap-2">
                              <button class="btn btn-primary text-uppercase" [disabled]="f.invalid" id="submitButton" type="submit">Send</button>
                            </div>
                        </form>
                    </div>
                </div>
